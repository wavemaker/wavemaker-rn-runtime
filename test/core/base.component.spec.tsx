...
import { BaseComponent, BaseProps } from '@source/core/base.component';
...
class SampleComponent extends BaseComponent<SampleProps> {
    ...
    render(): ReactNode {
        ...
        return (<TouchableOpacity onPress={() => this.invokeEventCallback('onTap', ['test_data', this])}>
...
describe('Test BaseComponent', () => {
  test('Check validity of sample component', () => {
    const tree = renderer.create(<SampleComponent name="test_button" caption="test_label"/>).toJSON();
    expect(tree).toMatchSnapshot();
  });

  test('Check init callback', () => {
    const onInitFn = jest.fn((i) => {});
    renderer.create(<SampleComponent name="test_button" caption="test_label" onInit={onInitFn}/>);
  ...
  test('Check component properties', () => {
    ...
    renderer.create(<SampleComponent name="test_button" caption="test_label" onInit={(i: any) => {
      componentInstance = i;
    }}/>);
  ...
  test('Check styles', () => {
    ...
    renderer.create(<SampleComponent name="test_button" caption="test_label" styles={styles} onInit={(i: any) => {
      componentInstance = i;
    }}/>);
  ...
  test('Check component events', () => {
    ...
    let wrapper = shallow(<SampleComponent name="test_button" caption="test_label" onTap={eventListener}/>);
  ...
  test('Check destroy callback', () => {
    ...
    const instance = renderer.create(<SampleComponent name="test_button" caption="test_label" onDestroy={onDestroyFn}/>);
