...
describe('Test List component', () => {
  ...
  it('should show horizontal scrollbar by default', () => {
    const props = createProps();
  ...
  it('should hide horizontal scrollbar when hidehorizontalscrollbar is true', () => {
  ...
  it('should show horizontal scrollbar when hidehorizontalscrollbar is false', () => {
  ...
  it('should not affect vertical list scrollbar', () => {
    const props = createProps({
      direction: 'vertical',
